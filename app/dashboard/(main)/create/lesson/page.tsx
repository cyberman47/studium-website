    ...
    <div className="mt-8 max-w-2xl space-y-6">
      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft sm:p-7">
        ...
        <div className="mt-3 space-y-4">
          {sampleLesson.mainConcepts.map(c => <div key={c.heading}>
            <p className="text-sm font-extrabold text-ink">{c.heading}</p>
      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft sm:p-7">
        ...
        <div className="mt-3 space-y-3">
          {sampleLesson.practiceQuestions.map((q, i) => <div key={i} className="rounded-2xl bg-[#f9fcfc] p-3.5">
      ...
      <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft sm:p-7">
        ...
        <div className="mt-3 flex flex-wrap gap-2">{sampleLesson.flashcards.map(f => <span key={f.question} className="rounded-full bg-teal-50 px-3 py-1.5 text-xs font-bold text-teal-700">{f.question}</span>)}</div>
      </div>
