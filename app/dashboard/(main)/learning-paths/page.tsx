...
const tracks = [
  { name: "Medical School", icon: GraduationCap, color: "bg-teal-100 dark:bg-teal-500/20 dark:text-teal-300 text-teal-700", href: "/dashboard/learning-paths/medical-school", meta: `${medicalSchoolTopics.length} Topics` },
  { name: "MCAT", icon: ClipboardCheck, color: "bg-violet-100 dark:bg-violet-500/20 dark:text-violet-300 text-violet-600", href: "/dashboard/learning-paths/mcat", meta: `${mcatSections.length} Sections · ${mcatLessonCount} Lessons Ready` },
  { name: "Nursing", icon: HeartHandshake, color: "bg-pink-100 dark:bg-pink-500/20 dark:text-pink-300 text-pink-600", href: "/dashboard/learning-paths/nursing", meta: `${nursingTopics.length} Topics` },
  ...
  { name: "Pharmacology", icon: Pill, color: "bg-indigo-100 dark:bg-indigo-500/20 dark:text-indigo-300 text-indigo-600", href: "/dashboard/learning-paths/pharmacology", meta: `${pharmacologyTopics.length} Topics` },
  ...
  { name: "Medical Cases", icon: Stethoscope, color: "bg-rose-100 dark:bg-rose-500/20 dark:text-rose-300 text-rose-600", href: "/dashboard/library/clinical-cases", meta: `${clinicalCases.length} Cases` },
  { name: "USMLE", icon: Award, color: "bg-amber-100 dark:bg-amber-500/20 dark:text-amber-300 text-amber-600", href: "/dashboard/learning-paths/usmle", meta: `${usmleTopics.length} Topics` }
];
...
export default function LearningPathsPage() {
  ...
  return <section data-tour="learning-paths-main" className="relative py-10 sm:py-14">
    ...
    <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_320px] lg:items-start">
        ...
        <div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-4 lg:grid-cols-4">
            {tracks.map(track => <Link
              key={track.name}
              href={track.href}
              className="group flex cursor-pointer flex-col items-start rounded-3xl border border-slate-100 dark:border-white/10 bg-white dark:bg-[#0d1917] p-5 shadow-soft transition-all hover:-translate-y-1 hover:shadow-lift"
            >
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-3xl border border-dashed border-slate-200 dark:border-white/10 bg-white dark:bg-[#0d1917] p-6 text-center shadow-soft">
