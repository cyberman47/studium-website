...
export default function McatReviewPage() {
  ...
  return <section className="relative py-10 sm:py-14">
    ...
    <div className="mt-10 grid gap-4 sm:grid-cols-3">
      <Reveal delay={0}>
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
          ...
          <p className="mt-3 text-2xl font-extrabold text-ink">{stats.dueCount}</p>
        </div>
      </Reveal>
      <Reveal delay={0.04}>
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
          ...
          <p className="mt-3 text-2xl font-extrabold text-ink">{stats.deckCount}</p>
        </div>
      </Reveal>
      <Reveal delay={0.08}>
        <div className="rounded-3xl border border-slate-100 bg-white p-6 shadow-soft">
          ...
          <p className="mt-3 text-2xl font-extrabold text-ink">{stats.weakCount}</p>
        </div>
      </Reveal>
    </div>
    ...
    <div className="mt-8 grid gap-4 sm:grid-cols-2">
      <Reveal delay={0.1}>
        <Link href="/dashboard/flashcards" className="group flex h-full flex-col rounded-3xl border border-slate-100 bg-white p-6 shadow-soft transition hover:-translate-y-0.5 hover:shadow-lift">
          <div className="flex items-start justify-between gap-3">
            <span className="grid h-11 w-11 place-items-center rounded-2xl bg-teal-100 text-teal-700"><RotateCcw size={19} /></span>
          ...
          <h2 className="mt-4 text-base font-extrabold tracking-tight text-ink">Open Flashcard Library</h2>
      ...
      <Reveal delay={0.14}>
        <Link href="/dashboard/flashcards" className="group flex h-full flex-col rounded-3xl border border-slate-100 bg-white p-6 shadow-soft transition hover:-translate-y-0.5 hover:shadow-lift">
          <div className="flex items-start justify-between gap-3">
            <span className="grid h-11 w-11 place-items-center rounded-2xl bg-violet-100 text-violet-600"><Layers size={19} /></span>
            <ArrowUpRight size={17} className="mt-1 shrink-0 text-slate-300 transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-teal-500" />
          </div>
          <h2 className="mt-4 text-base font-extrabold tracking-tight text-ink">My Decks</h2>
    ...
    <div className="mt-8 rounded-3xl border border-amber-100 bg-amber-50/60 p-6 shadow-soft sm:p-7">
      <div className="flex items-center gap-3">
        <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-white text-amber-700 shadow-soft"><TriangleAlert size={19} /></span>
        <div>
          <h2 className="text-base font-extrabold tracking-tight text-ink">Weak Areas</h2>
