...
export default function McatStartHerePage() {
  ...
  return <section className="relative py-10 sm:py-14">
    ...
    <div className="mt-10 max-w-2xl space-y-6">
      <Reveal delay={0}>
        <div className="rounded-3xl border border-slate-100 dark:border-white/10 bg-white dark:bg-[#0d1917] p-7 shadow-soft sm:p-8">
          <span className="grid h-11 w-11 place-items-center rounded-2xl bg-teal-100 dark:bg-teal-500/20 dark:text-teal-300 text-teal-700"><GraduationCap size={20} /></span>
          <h2 className="mt-4 text-lg font-extrabold tracking-tight text-heading">What is the MCAT?</h2>
      ...
      <Reveal delay={0.05}>
        <div className="rounded-3xl border border-slate-100 dark:border-white/10 bg-white dark:bg-[#0d1917] p-7 shadow-soft sm:p-8">
          <span className="grid h-11 w-11 place-items-center rounded-2xl bg-violet-100 dark:bg-violet-500/20 dark:text-violet-300 text-violet-600"><Clock3 size={20} /></span>
          <h2 className="mt-4 text-lg font-extrabold tracking-tight text-heading">How the MCAT works</h2>
          ...
          <ul className="mt-3 space-y-2 text-sm leading-relaxed text-slate-600">
            <li className="flex gap-2"><span className="font-extrabold text-heading">Bio &amp; Biochem —</span> how living systems work, from molecules to organ systems.</li>
            <li className="flex gap-2"><span className="font-extrabold text-heading">Chem &amp; Phys —</span> the chemistry and physics underlying biological systems.</li>
            <li className="flex gap-2"><span className="font-extrabold text-heading">Psych, Social &amp; Bio of Behavior —</span> how psychological, social, and biological factors shape behavior and health.</li>
            <li className="flex gap-2"><span className="font-extrabold text-heading">CARS —</span> reading comprehension and reasoning about humanities/social science passages—no outside content knowledge required.</li>
          </ul>
      ...
      <Reveal delay={0.1}>
        <div className="rounded-3xl border border-slate-100 dark:border-white/10 bg-white dark:bg-[#0d1917] p-7 shadow-soft sm:p-8">
          <span className="grid h-11 w-11 place-items-center rounded-2xl bg-amber-100 dark:bg-amber-500/20 dark:text-amber-300 text-amber-700"><Compass size={20} /></span>
          <h2 className="mt-4 text-lg font-extrabold tracking-tight text-heading">How to use Studium for MCAT prep</h2>
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl bg-[#f9fcfc] dark:bg-white/5 p-4">
              <BookOpenCheck size={16} className="text-teal-600" />
              <p className="mt-2 text-sm font-extrabold text-heading">Learn</p>
            ...
            <div className="rounded-2xl bg-[#f9fcfc] dark:bg-white/5 p-4">
              ...
              <p className="mt-2 text-sm font-extrabold text-heading">Practice</p>
            ...
            <div className="rounded-2xl bg-[#f9fcfc] dark:bg-white/5 p-4">
              ...
              <p className="mt-2 text-sm font-extrabold text-heading">Review</p>
