...
import { ArrowRight, BookA, Bot, CalendarCheck, Crown, Home, IdCard, Layers, Library, ListChecks, Map, PenLine, TrendingUp, Users } from "lucide-react";
...
type NavItem = { label: string; href: string; icon: typeof Home; flag?: "ai_tutor_nav"; tourId?: string };
